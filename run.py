...
if __name__ == '__main__':
    ...
    对mimens.xml 进行 倍增
    """
    old_file = r"/Users/heyue/Documents/fenghe/fixface/beeboxes/packages/apps/BboxSetupWizard/app/src/main/res/values-1280x800/dimens.xml" # 老的style 或者 dimens文件
    new_file = r"/Users/heyue/Documents/fenghe/fixface/beeboxes/packages/apps/BboxSetupWizard/app/src/main/res/values-1200x720/dimens.xml"# 新的 新尺寸的 dimens文件
