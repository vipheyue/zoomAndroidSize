...
if __name__ == '__main__':
    ...
    dimens_xml_file = r"/Users/heyue/Documents/fenghe/fixface/beeboxes/packages/apps/BboxSetupWizard/app/src/main/res/values-1280x800/dimens.xml"  # 输出dimens.xml文件 之后需要手动粘贴

    inputDir = r"/Users/heyue/Documents/fenghe/fixface/beeboxes/packages/apps/BboxSetupWizard/app/src/main/res/layout"  # layout  输入文件夹
    outputDir = r"/Users/heyue/Desktop/img"  # layout 输出文件夹
    extra_layout(inputDir, outputDir)  # 抽取layout

    input_style_file = r"/Users/heyue/Documents/fenghe/fixface/beeboxes/packages/apps/BboxSetupWizard/app/src/main/res/values/styles.xml"  # style.xml文件
    output_style_file = r"/Users/heyue/Desktop/img/styles.xml"  # 输出style.xml文件
